...
Incorporating simple TSM implicits into a bidirectionally typed variant of $\miniVerseParam$ would require that the TSM implicit context, $\uI$, be a finite function from \emph{equivalence classes} of types to TSM expressions, $\epsilon$, rather than from syntactic types, $\tau$, to TSM names, $a$.

...
\begin{lemma}[Substitution]\label{lemma:substitution-P} ~
\begin{enumerate}
\item If $\Omega, X : \sigma \cup \Omega' \vdash J$ and $\hassigX{M}{\sigma}$ and $\ismvalX{M}$ then $\Omega \cup [M/X]\Omega' \vdash [M/X]J$.
\item If $\Omega, u :: \kappa \cup \Omega' \vdash J$ and $\haskindX{c}{\kappa}$ then $\Omega \cup [c/u]\Omega' \vdash [c/u]J$.
\item If $\Omega, x : \tau \cup \Omega' \vdash J$ and $\hastypeP{\Omega}{e}{\tau}$ then $\Omega \cup [e/x]\Omega' \vdash [e/x]J$.
\end{enumerate}
\end{lemma}
\begin{proof-sketch} By straightforward mutual rule induction. 
\end{proof-sketch}
...
\begin{enumerate}
\item If $\Omega \cup [M/X]\Omega' \vdash [M/X]J$ and $\hassigX{M}{\sigma}$ then $\Omega, X : \sigma \cup \Omega' \vdash J$.
\item If $\Omega \cup [c/u]\Omega' \vdash [c/u]J$ and $\haskindX{c}{\kappa}$ then $\Omega \cup \Omega' \vdash J$.
\item If $\Omega \cup [e/x]\Omega' \vdash [e/x]J$ and $\hastypeP{\Omega}{e}{\tau}$ then $\Omega \cup \Omega' \vdash J$.
\end{enumerate}
\end{lemma}
\begin{proof-sketch} By straightforward mutual rule induction.
\end{proof-sketch}

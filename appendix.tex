...
\end{theorem}
\begin{proof-sketch} The proof is nearly identical to the proof of Theorem \ref{thm:peTSM-preservation}, differing only in that the corresponding ppTSM contexts and judgements are mentioned. \end{proof-sketch}

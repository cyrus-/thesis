...
\begin{byCases}
  \item[\text{(\ref{rule:prepcp-cepat})}] We have:
    \begin{pfsteps*}
      ...
      \item $\hastsmtypePat{\Omega_\text{app}}{\Phi}{a}{\rho}$ \BY{Rule (\ref{rule:hastsmtypePat-defref}) on \pfref{istsmty}}
    \end{pfsteps*}
    \resetpfcounter
  \item[\text{(\ref{rule:prepcp-allmods})}] We have:
    \begin{pfsteps*}
      ...
      \item $\hastypeP{\Omega_\text{app}}{\omega', X/X'}{\Omega', X' : \sigma}$ \BY{definition of substitution typing on \pfref{hassig}}
...
\item In the following, let $\uOmega = \uOmegaEx{\uD}{\uG}{\uMctx}{\Omega_\text{app}}$ and $\uOmega' = \uOmegaEx{\uD'}{\uG'}{\uMctx'}{\Omega'}$.
  \begin{byCases}
    ...
    \item $\cvalidPP{\uOmega'}{\psceneP{\omega : \Omega_\text{params}}{\uOmega}{\uPhi}{b}}{\cpv}{p}{\tau_\text{proto}}$ \BY{assumption}

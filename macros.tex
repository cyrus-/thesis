...
\newcommand{\defpetsm}[4]{\texttt{syntax}~#1~\texttt{at}~#2~\texttt{for}~\texttt{expressions}~\texttt{by}~#3~\texttt{in}~#4}
\newcommand{\defpptsm}[4]{\texttt{syntax}~#1~\texttt{at}~#2~\texttt{for}~\texttt{patterns}~\texttt{by}~#3~\texttt{in}~#4}
...
\newcommand{\cvalidPPE}[5]{\Omega \vdash^{#2} #3 \leadsto #4 : #5~\dashVx^{\,#1}}
\newcommand{\cvalidPP}[5]{\Omega_\text{params} \vdash^{#2} #3 \leadsto #4 : #5~\dashVx^{\,#1}}

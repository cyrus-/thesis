...
\newcommand{\aein}[4]{\abopic{inj}{#1; #2}{#3}{#4}}
\newcommand{\auin}[4]{\abopic{uinj}{#1; #2}{#3}{#4}}
\newcommand{\acein}[4]{\abopic{prinj}{#1; #2}{#3}{#4}}
...
\newcommand{\usyntaxup}[4]{\texttt{syntax}~#1~\texttt{at}~#2~\texttt{for}~\texttt{patterns}~\texttt{by}~\texttt{static}~#3~\texttt{end}~\texttt{in}~#4}
...
\newcommand{\tCEPat}{\mathtt{ProtoPat}} % Typed expansion

\newcommand{\decodeCEPat}[2]{#1 \uparrow_\mathsf{ProtoPat} #2}
\newcommand{\encodeCEPat}[2]{#1 \downarrow_\mathsf{ProtoPat} #2}

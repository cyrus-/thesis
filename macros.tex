...
\newcommand{\recu}[3]{\mu(#1 :: #2).#3}
\newcommand{\arecu}[3]{\abopc{rec}{#1}{#2.#3}}
...
\newcommand{\kunit}{\langle\rangle}
\newcommand{\akunit}{\texttt{unit}}

\newcommand{\kdprod}[3]{\langle #1 :: #2~\texttt{in}~#3 \rangle}
\newcommand{\akdprod}[3]{\abop{dprod}{#1; #2.#3}}

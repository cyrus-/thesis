...
\newcommand{\footnotesimplelang}{\textsf{\textbf{\footnotesize Calc}}}
...
\newcommand{\inj}[2]{\texttt{inj}~#1 \cdot #2}
...
\newcommand{\splicedt}[2]{\texttt{splicedt}\langle#1, #2\rangle}
\newcommand{\asplicedt}[2]{\texttt{splicedt}[#1; #2]}
\newcommand{\acesplicedt}[2]{\texttt{cesplicedt}[#1; #2]}
\newcommand{\splicede}[2]{\texttt{splicede}\langle#1, #2\rangle}
\newcommand{\asplicede}[2]{\texttt{splicede}[#1; #2]}
\newcommand{\acesplicede}[2]{\texttt{cesplicede}[#1; #2]}
\newcommand{\splicedp}[2]{\texttt{splicedp}\langle#1, #2\rangle}
\newcommand{\acesplicedp}[2]{\texttt{cesplicedp}[#1; #2]}
\newcommand{\splicedc}[2]{\texttt{splicedc}\langle #1, #2 \rangle}
\newcommand{\acesplicedc}[2]{\texttt{cesplicedc}[#1; #2]}
\newcommand{\splicedk}[2]{\texttt{splicedk}\langle #1, #2 \rangle}
...
\newcommand{\injp}[2]{\texttt{inj}~#1 \cdot #2}
...
\newcommand{\acecasc}[2]{\abopc{ceasc}{#1}{#2}}
...
\newcommand{\msynX}[3]{\msyn{\uOmega}{\uPsiE}{\uPsiP}{#1}{#2}{#3}}
...
\newcommand{\pcp}{\check{p}}

\newcommand{\prepce}[8]{#1 \vdash_{#2}^\mathsf{Exp} #3 \looparrowright_{#5} #4 ~?~ #6 \dashv #7 : #8}
\newcommand{\prepcp}[6]{#1 \vdash_{#2}^\mathsf{Pat} \cdot \looparrowright_{#3} \cdot ~?~ #4 \dashv #5 : #6}
...
\newcommand{\cvalidPP}[5]{\Omega_\text{param} \vdash^{#2} #3 \leadsto #4 : #5~\dashVx^{\,#1}}

\newcommand{\isvalP}[2]{#1 \vdash #2~\mathsf{val}}

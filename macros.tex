...
\newcommand{\escenev}{\mathcal{S}}
\newcommand{\sceneU}[4]{#1;\,#2;\,#3;\,#4}
\newcommand{\sceneUP}[5]{#1;\,#2;\,#3;\,#4;\,#5}
...
\newcommand{\cvalidP}[4]{\vdash^{#1} #2 \leadsto #3 : #4}
\newcommand{\pscenev}{\mathcal{P}}

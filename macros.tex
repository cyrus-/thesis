...
\newcommand{\tCEExp}{\mathtt{CEExp}}

% Typed expansion
\newcommand{\expandsU}[6]{#1~#2 \vdash_{#3} #4 \leadsto #5 : #6}
...
% Marked expressions
\newcommand{\me}{\dot{e}}
\newcommand{\mspliced}[1]{\texttt{spliced}(#1)}

% Candidate expansion validation
\newcommand{\cvalidE}[9]{#1~#2\vdash^{#3; #4; #5; #6} #7 \leadsto #8 : #9}

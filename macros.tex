...
\newcommand{\patExpands}[5]{#3 \leadsto #4 : #5 \,\dashVx_{#2}\,#1}
...
\newcommand{\cvalidP}[5]{#3 \leadsto #4 : #5~\dashVx_{#2}\,{#1}}
...
\newcommand{\pExpandsSP}[6]{#3 \leadsto #4 : #5 \,\dashVx_{#2}\,#6}
\newcommand{\patExpandsP}[5]{#3 \leadsto #4 : #5 \,\dashVx_{#2}\,#1}
...
\newcommand{\cvalidPPE}[5]{#3 \leadsto #4 : #5~\dashVx_{#2}{\,#1}}
\newcommand{\cvalidPP}[5]{#3 \leadsto #4 : #5~\dashVx_{#2}{\,#1}}

...
\newcommand{\istypeP}[2]{#1 \vdash #2 :: \akty}
...
\newcommand{\mstat}[1]{#1\cdot\texttt{s}}
\newcommand{\amstat}[1]{\abop{stat}{#1}}

\newcommand{\mdyn}[1]{#1 \cdot \texttt{d}}
\newcommand{\amdyn}[1]{\abop{dyn}{#1}}

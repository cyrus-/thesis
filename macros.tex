...
\newcommand{\acefold}[3]{\abopc{prfold}{#1.#2}{#3}}
...
\newcommand{\acetpl}[2]{\abopi{prtpl}{#1}{#2}}

\newcommand{\prj}[2]{#1 \cdot #2}
\newcommand{\aepr}[2]{\abopp{prj}{#1}{#2}}
\newcommand{\aupr}[2]{\abopp{uprj}{#1}{#2}}
\newcommand{\acepr}[2]{\abopp{prprj}{#1}{#2}}

\newcommand{\injt}[3]{\texttt{inj}_{#1}~#2 \cdot #3}
\newcommand{\inj}[2]{\texttt{inj}~#1 \cdot #2}
\newcommand{\aein}[4]{\abopibc{inj}{#1}{#2}{#3}{#4}}
\newcommand{\auin}[4]{\abopibc{uinj}{#1}{#2}{#3}{#4}}
\newcommand{\acein}[4]{\abopibc{prinj}{#1}{#2}{#3}{#4}}

\newcommand{\auanain}[2]{\abopp{uin}{#1}{#2}}
\newcommand{\aceanain}[2]{\abopp{prin}{#1}{#2}}

\newcommand{\caseof}[2]{\texttt{case}~#1~#2}
\newcommand{\aecase}[4]{\abopic{case}{#1}{#2}{#3; #4}}
\newcommand{\aucase}[4]{\abopic{ucase}{#1}{#2}{#3; #4}}
\newcommand{\acecase}[4]{\abopic{prcase}{#1}{#2}{#3; #4}}
...
\newcommand{\ue}{{\hat e}}
\newcommand{\ux}{{\hat x}}
\newcommand{\uesyntax}[4]{\texttt{syntax}~#1~\texttt{at}~#2~\texttt{by}~\texttt{static}~#3~\texttt{end}~\texttt{in}~#4}
...
\newcommand{\tCEExp}{\mathtt{ProtoExpr}} % Typed expansion
...
\newcommand{\decodeCondE}[2]{#1 \uparrow_\mathsf{ProtoExpr} #2}
\newcommand{\encodeCondE}[2]{#1 \downarrow_\mathsf{ProtoExpr} #2}
...
\newcommand{\acematchwith}[4]{\abopic{prmatch}{#1}{#2}{#3; #4}}
...
\newcommand{\aceinjp}[2]{\abopp{prinp}{#1}{#2}}
...
\newcommand{\tParseResultCEPat}{\mathtt{ParseResult}(\mathtt{prPat})}

...
\end{lstlisting}
\end{minipage}
\begin{minipage}{0.5\textwidth}%\vspace{-13px}
\[\footnotesize
\begin{array}{l}
\asignature{\akdbprod{\\
\quad\quad \akty}{t}{\\
...
The top level of a program consists of a module expression, $M$. The module let binding form allows the programmer to bind a module to a module variable, $X$:
...
\todo{statics metatheory: Weakening, Substitution, etc. + reflexivity/transitivity/etc. properties of equality, subtyping}

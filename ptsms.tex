...
\end{array}
\]
\caption{Syntax of unexpanded TSM types and expressions  in $\miniVerseParam$}
...
\end{array}\]
\caption[Syntax of TSM types and expressions in $\miniVerseParam$]{Syntax of TSM types and expressions  in $\miniVerseParam$}

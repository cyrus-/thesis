...
Some macro systems for languages with non-trivial type structure, like Template Haskell \cite{sheard2002template}, do not support reasoning about types in that the guarantee is only that the expansion is well-typed -- clients cannot reason about \emph{what that type is}. 

...
\begin{abstract}
\noindent
Programming languages commonly build in ``syntactic sugar'' that decreases the syntactic cost of working with selected standard library constructs.   

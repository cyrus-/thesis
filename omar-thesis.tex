...
\item a \emph{hygienic binding discipline}, meaning that 
  ...
  \item literal expansions cannot refer to application site bindings directly. Instead, all interactions with  application site bindings go through either \emph{spliced subterms} or \emph{parameters}. %Partial parameter application helps reduce the syntactic cost of this explicit parameter passing style.
  \end{enumerate}
\end{itemize}
\noindent

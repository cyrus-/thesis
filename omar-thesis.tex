...
\keywords{syntax, parsing, type systems, module systems, macro systems, hygiene, pattern matching, bidirectional typechecking, implicit dispatch, metaprogramming}
...
\item a \emph{hygienic binding discipline}, meaning that the client can be sure that:
  \begin{enumerate}
    \item  literal expansions cannot shadow bindings that appear at the TSM application site; and 

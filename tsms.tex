...
\subsubsection{Statics of Expanded Expressions and Patterns}
The \emph{statics of expanded expressions and patterns} is specified by judgements of the following form:

$\hastypeU{\Delta}{\Gamma}{e}{\tau}$, $\istypeU{\tau}$, $\isctxU{\Gamma}$, 
type formation, context formation, typing, rule typing, pattern typing
